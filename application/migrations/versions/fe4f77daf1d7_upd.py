...
Revision ID: fe4f77daf1d7
Revises: 885ed7c79255
Create Date: 2024-01-25 17:37:05.719014
...
revision: str = 'fe4f77daf1d7'
down_revision: Union[str, None] = '885ed7c79255'
...
def upgrade() -> None:
    ...
    sa.Column('total_cost', sa.Integer(), sa.Computed('price*(date_to-date_from)', ), nullable=True),
